...
Public Class Accounts
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        Dim con As New MySqlConnection("server=" + server + ";" + "user id=" + username + ";" _
            + "password=" + password + ";" + "database=" + database)
        con.Open()
        Dim command As New MySqlCommand("update patiensdb.patiensdbtable set Bill='" & TextBox1.Text & "',DateAdded= '" & TextBox2.Text & "' where CaseNumber='" & TextBox3.Text & "'", con)
    ...
    Private Sub Label2_Click_1(sender As Object, e As EventArgs) Handles Label2.Click, Label4.Click, Label3.Click
